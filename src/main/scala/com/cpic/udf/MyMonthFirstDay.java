...
public class MyMonthFirstDay extends UDF {
	public String evaluate(String arg1) {
		try {
			return DateUtils.convertDateToStr(DateUtils.getFirstDayOfMonth(DateUtils.parseToDate(arg1)), "yyyy-MM-dd");
		} catch (Exception e) {
			e.printStackTrace();
			return "";
		}
	...
	public static void main(String[] args) throws ParseException {
		System.out.println(new MyMonthFirstDay().evaluate("20081391"));
	}
}
/*
 * set role admin;
