...
public class MyYearfirstDay extends UDF {
	public String evaluate(String arg1) {
		try {
			return DateUtils.convertDateToStr(DateUtils.getFirstDayOfYear(DateUtils.parseToDate(arg1)), "yyyy-MM-dd");
		} catch (Exception e) {
			e.printStackTrace();
			return "";
		}
	...
	public static void main(String[] args) throws ParseException {
		System.out.println(new MyYearfirstDay().evaluate("2008/02/11"));
	}
}
/*
 * set role admin;
