...
public class MyYearLastDay extends UDF {
	public String evaluate(String arg1) {
		try {
			return DateUtils.convertDateToStr(DateUtils.getLastDayOfYear(DateUtils.parseToDate(arg1)), "yyyy-MM-dd");
		} catch (Exception e) {
			e.printStackTrace();
			return "";
		}
	...
	public static void main(String[] args) throws ParseException {
		System.out.println(new MyYearLastDay().evaluate("20080211"));
	}
}
/*
 * set role admin;
