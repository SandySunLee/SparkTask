...
public class DBUtils {
    ...
    private static void loadProp() {
        ...
        url = PublicConstant.oracleDriverUrl();
        username = PublicConstant.ousername();
        password = PublicConstant.opassword();
        initialSize = PublicConstant.initialSize();
        maxActive = PublicConstant.maxActive();
        maxWait = PublicConstant.maxWait();
        minIdle = PublicConstant.minIdle();
    }
